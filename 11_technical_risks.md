...
This section describes the most important technical risks and debts that result from the chosen [solution strategy](04_solution_strategy.md) and [architecture decisions](09_architecture_decisions.md).

The risks are based on the modular monolith, the [integration with existing university systems](03_context_and_scope.md), and the [role-based access control](08_concepts.md#81-authentication-and-authorization) described in the previous sections.
...
The controlled handling of notification and FMS failures referenced by these risks is illustrated in the [Runtime View](06_runtime_view.md).
...
[← Previous: Quality Requirements](10_quality_requirements.md) | [Overview](README.md) | [Next: Glossary →](12_glossary.md)
